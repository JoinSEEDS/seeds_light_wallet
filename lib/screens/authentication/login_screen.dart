          ...
          onPressed: () {
            if (settingsStorage.inRecoveryMode) {
              NavigationService.of(context).navigateTo(
                  Routes.recoverAccountFound, settingsStorage.accountName);
            } else {
              NavigationService.of(context)
                  .navigateTo(Routes.recoverAccountSearch);
            }
          },
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text(context.loc.loginRecoverAccountActionSegment1,
                  style: Theme.of(context).textTheme.titleSmall),
              Text(context.loc.loginRecoverAccountActionLink,
                  style:
                      Theme.of(context).textTheme.subtitle2HighEmphasisGreen1),
              Text(context.loc.loginRecoverAccountActionSegment2,
                  style: Theme.of(context).textTheme.titleSmall),
            ],
          ),
        ),
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(context.loc.loginFirstTimeHere,
                        style: Theme.of(context).textTheme.titleSmall),
                    ...
                    FlatButtonLongOutlined(
                      onPressed: () {
                        ...
                        if (remoteConfigurations
                            .featureFlagExportRecoveryPhraseEnabled) {
                          NavigationService.of(context)
