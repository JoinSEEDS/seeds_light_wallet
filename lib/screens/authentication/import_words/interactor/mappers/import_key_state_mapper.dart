...
class ImportWordsStateMapper extends StateMapper {
  ImportWordsState mapResultsToState(ImportWordsState currentState, List<Result> results, String privateKey) {
