  ...
  DelegateState mapResultToState(DelegateState currentState, Result result) {
    if (result.isError) {
      ...
      return currentState.copyWith(
          pageState: PageState.success, pageCommand: ShowErrorMessage('Fail to remove delegate'));
    } else {
      return currentState.copyWith(pageState: PageState.success, activeDelegate: false);
    }
  }
}
