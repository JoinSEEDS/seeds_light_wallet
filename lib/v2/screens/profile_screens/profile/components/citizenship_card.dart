...
class CitizenshipCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return profile.status != ProfileStatus.citizen
        ? Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Text(profile.statusString, style: Theme.of(context).textTheme.headline6Green),
                                  Padding(
                                  ...
                                  Flexible(
                                    child: Text(profile.status == ProfileStatus.visitor ? 'Resident' : 'Citizen'.i18n,
