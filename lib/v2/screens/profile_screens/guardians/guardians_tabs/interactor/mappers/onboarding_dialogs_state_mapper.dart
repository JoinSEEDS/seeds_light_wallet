    ...
    switch (index) {
      ...
      case 3:
        pageCommand = ShowOnboardingGuardianDoubleAction(
          ...
          description:
          "If you ever lose your phone, forget your password or keyphrase, your Key Guardians will help you recover your account.".i18n,
        );
        break;
      ...
      case 4:
        pageCommand = ShowOnboardingGuardianDoubleAction(
            ...
            description:
            "Make sure to choose your guardians carefully and give them a heads up. The safety of your account may depend on them in the future!".i18n);
        break;
    }
