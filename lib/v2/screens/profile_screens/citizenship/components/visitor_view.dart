...
class _VisitorViewState extends State<VisitorView> with TickerProviderStateMixin {
  static const int resident_required_reputation = 50;
  static const int resident_required_visitors_invited = 1;
  static const int resident_required_planted_seeds = 200;
  static const int resident_required_seeds_transactions = 1;
  static const int resident_required_user_invited = 1;
  ...
  late Animation<double> _timeLineAnimation,
      ...
      _usersAnimation;
  int _timeLine = 0, _reputation = 0, _visitors = 0, _seeds = 0, _transactions = 0, _users = 0;
            ...
            children: [
              ...
              GridView.count(
                ...
                children: <Widget>[
                  ...
                  CircularProgressItem(
                    icon: SvgPicture.asset('assets/images/citizenship/community.svg'),
                    totalStep: resident_required_user_invited,
                    currentStep: _users,
                    circleRadius: 30,
                    title: 'Invited Users'.i18n,
                    titleStyle: Theme.of(context).textTheme.subtitle3,
                    rate: '${_users ~/ 100}/$resident_required_user_invited',
                    rateStyle: Theme.of(context).textTheme.subtitle1!,
                  ),
                ],
              ),
