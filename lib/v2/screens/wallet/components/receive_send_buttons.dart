              ...
              Expanded(
                child: Opacity(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () => NavigationService.of(context).navigateTo(Routes.transfer, state.selectedToken),
              ...
              Expanded(
                child: Opacity(
                  ...
                  child: MaterialButton(
                    padding: const EdgeInsets.only(top: 14, bottom: 14),
                    onPressed: () =>
                        NavigationService.of(context).navigateTo(Routes.receiveEnterDataScreen, state.selectedToken),
                    color: AppColors.green1,
                    disabledColor: AppColors.green1,
                    shape: const RoundedRectangleBorder(
                      borderRadius: BorderRadius.only(
