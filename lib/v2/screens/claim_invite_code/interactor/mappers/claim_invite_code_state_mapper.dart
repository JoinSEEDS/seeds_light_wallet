...
class IClaimInviteCodeStateMapper extends StateMapper {
  ClaimInviteCodeState mapResultsToState(ClaimInviteCodeState currentState, List<Result> results, String privateKey) {
